...
if (temperature >= 80 && rain) {
  console.log("wear tshirt take umberlla");
} else if (temperature > 60 && temperature < 80 && rain) {
  console.log("wear rain jacket");
} else {
  temperature < 60;
  console.log("wear a jacket carry umberlla");
}
...
//CODE HERE
while (score < 7) {
  console.log("Your score isnt high enough");
  score += 1;
}
...
console.log(`The new value is: ${changeMyMind}`);
////////// ADVANCED PROBLEMS //////////
